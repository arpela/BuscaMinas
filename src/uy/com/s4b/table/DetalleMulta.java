...
public class DetalleMulta extends MainScreen {
	...
	public DetalleMulta(Object[] datosMulta) {
		...
		add(new LabelField("Detalle de la multa!", LabelField.FIELD_HCENTER));
		add(new SeparatorField());
		Dialog.alert((String) datosMulta[Resultados.MATRICULA_DNI]);
		
		
		_tableModel = new SortedTableModel(StringComparator.getInstance(true), FECHA);
		...
		DataTemplate dataTemplate = new DataTemplate(tableView, 7, 2) {
